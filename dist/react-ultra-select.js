(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-ultra-select"] = factory(require("react"), require("react-dom"));
	else
		root["react-ultra-select"] = factory(root["react"], root["react-dom"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UltraSelect = function (_Component) {
	    ...
	    function UltraSelect(props) {
	        ...
	        _this.state = {
	            selected: selected,
	            title: _this.getTitle(props.columns, selected, false),
	            staticText: _this.getTitle(props.columns, selected, true),
	            open: false
	        };
	        return _this;
	    }
	    ...
	    _createClass(UltraSelect, [{
	        key: 'getTitle',
	        value: function getTitle(columns, selected, isStatic) {
	            var ret = [];
	        ...
	        value: function onScroll(instance) {
	            ...
	            if (elem) {
	                ...
	                var selectedNew = _calculateSelected(instance.y, this.props.columns[index].list.length, this.props.rowsVisible, elem.clientHeight, instance.scrollerHeight);
	                if (selectedBefore !== selectedNew) {
	                    var _selected = [].concat(_toConsumableArray(this.state.selected));
	                    _selected[index] = selectedNew;
	                    this.setState(_extends({}, this.state, {
	                        selected: _selected,
	                        title: this.getTitle(this.props.columns, _selected, false),
	                        staticText: this.getTitle(this.props.columns, _selected, true)
	                    }));
	                }
	            }
	        }
	...
	UltraSelect.propTypes = {
	    columns: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	        list: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.func]).isRequired,
	    ...
	    setStaticText: _react.PropTypes.func,
